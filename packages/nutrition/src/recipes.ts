...
export const recipeTemplates: RecipeTemplate[] = [
  ...
  {
    title: 'Tostada integral con huevo, tomate y espinacas',
    locale: 'es',
    description: 'Tostada salada sin aguacate, con huevo, tomate jugoso y espinacas para mantener volumen.',
    servings: 1,
    prepTimeMinutes: 15,
    cuisine: 'casera',
    flavorProfile: 'tostado, salado, fresco',
    tags: ['desayuno', 'saciante'],
    slots: ['breakfast', 'snack'],
    ingredients: [
      { name: 'pan integral', amount: 70, unit: 'g' },
      { name: 'huevos', amount: 110, unit: 'g' },
      { name: 'tomate', amount: 120, unit: 'g' },
      { name: 'espinacas', amount: 80, unit: 'g' },
      { name: 'aceite de oliva', amount: 4, unit: 'g' },
    ],
    steps: ['Tuesta el pan integral.', 'Saltea las espinacas con el aceite.', 'Añade el huevo y termina con tomate fresco.'],
  },
  {
    title: 'Revuelto de huevo con patata, tomate y espinacas',
    locale: 'es',
    description: 'Revuelto caliente y sencillo, con carbohidrato suave y verduras sin depender de aguacate.',
    servings: 1,
    prepTimeMinutes: 25,
    cuisine: 'casera',
    flavorProfile: 'salado, jugoso, suave',
    tags: ['desayuno', 'templado'],
    slots: ['breakfast', 'snack'],
    ingredients: [
      { name: 'huevos', amount: 120, unit: 'g' },
      { name: 'patata', amount: 170, unit: 'g' },
      { name: 'tomate', amount: 100, unit: 'g' },
      { name: 'espinacas', amount: 70, unit: 'g' },
      { name: 'aceite de oliva', amount: 5, unit: 'g' },
    ],
    steps: ['Cuece o saltea la patata en dados.', 'Añade tomate y espinacas.', 'Incorpora el huevo y remueve hasta que quede jugoso.'],
  },
  {
    title: 'Tostada de huevo y atún con tomate',
    locale: 'es',
    description: 'Alternativa salada y alta en proteína, crujiente y fresca sin aguacate.',
    servings: 1,
    prepTimeMinutes: 12,
    cuisine: 'mediterránea',
    ...
    ingredients: [
      ...
      { name: 'atún', amount: 70, unit: 'g' },
      { name: 'tomate', amount: 100, unit: 'g' },
    ],
    steps: ['Tuesta el pan.', 'Cocina el huevo y mezcla el atún con tomate.', 'Monta la tostada justo antes de comer.'],
  },
  {
